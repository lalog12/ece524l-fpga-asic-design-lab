...
HD_PWD='C:/Users/eduar/Documents/GitHub/school/ece524l-fpga-asic-design-lab/lab0-digital-logic-project/lab0-digital-logic-project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log swToLed.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source swToLed.tcl -notrace

...
HD_PWD='C:/Users/eduar/Documents/GitHub/school/ece524l-fpga-asic-design-lab/lab0-digital-logic-project/lab0-digital-logic-project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swToLed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swToLed.tcl

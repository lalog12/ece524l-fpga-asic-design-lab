...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {clk_50MHz}];  # "GCLK"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {mux_out[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {mux_out[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {mux_out[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {mux_out[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {mux_out[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {mux_out[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {mux_out[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {mux_out[7]}];  # "LD7"
...
#set_property PACKAGE_PIN N15 [get_ports {pause}];  # "BTNL"
...
set_property PACKAGE_PIN F21 [get_ports {direction}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {pause}];  # "SW4"

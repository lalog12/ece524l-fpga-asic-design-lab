...
HD_PWD='C:/Users/eduar/Documents/GitHub/school/ece524l-fpga-asic-design-lab/lab-1-clocks-and-counters-project/lab-1-clocks-and-counters-project-feranmi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_counter_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_counter_mux.tcl
